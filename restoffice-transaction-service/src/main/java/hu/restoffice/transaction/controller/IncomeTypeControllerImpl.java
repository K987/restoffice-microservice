...
public class IncomeTypeControllerImpl implements IncomeTypeController {
     ...
     */
    @Override
    public ResponseEntity<?> addResource(final IncomeTypeStub stub) throws ServiceException {
     ...
     */
    @Override
    public ResponseEntity<Object> updateResource(final Long id, final IncomeTypeStub stub) throws ServiceException {
